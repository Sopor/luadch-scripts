...
hub.setlistener( "onStart", { },
  function( p )
   ...
   if help then
    ...
    ucmd.add( { ucmd_menu,"TV","720p",ucmd_add }, cmd_Add, { "TV_720p_WEBRip", "%[line:Name:]" }, { "CT1" }, Add )
    ucmd.add( { ucmd_menu,"TV","720p",ucmd_show }, cmd_Show, { "TV_720p_WEBRip"}, { "CT1" }, Show )
    ...
    ucmd.add( { ucmd_menu,"TV","1080p",ucmd_add }, cmd_Add, { "TV_1080p_WEBRip", "%[line:Name:]" }, { "CT1" }, Add )
    ucmd.add( { ucmd_menu,"TV","1080p",ucmd_show }, cmd_Show, { "TV_1080p_WEBRip"}, { "CT1" }, Show )
